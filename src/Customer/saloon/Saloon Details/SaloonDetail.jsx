        ...
        <div className='space-y-5 mb-20'>
            <section className="grid grid-cols-2 gap-3">
                ...
                <div className='col-span-1'>
                    <img className='w-full rounded-md h-[15rem] object-cover' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRx0RIppj5aIC1KRh2aerPBmj-dv5CwiJzlcQ&s" alt="" />
                </div>
                <div className='col-span-1'>
